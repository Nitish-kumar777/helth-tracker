              ...
              <table cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="padding-left:12px;vertical-align:middle;">
                    <span style="font-size:20px;font-weight:800;color:#fff;letter-spacing:-0.5px;">HealthTrack</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding-top:24px;text-align:center;">
              <p style="color:rgba(255,255,255,0.2);font-size:11px;margin:0;font-family:monospace;">
                © ${new Date().getFullYear()} HealthTrack · You're receiving this because you have an account.
              </p>
            </td>
          </tr>
...
export function sendPasswordResetCode(to, code) {
  return sendEmail({
    to,
    subject: "HealthTrack — Password Reset Code",
    template: {
      type: "otp",
      data: {
        code,
        title:    "Reset Your Password",
        subtitle: "Use the 6-digit code below to reset your HealthTrack password.",
...
export function sendEmailChangeCode(to, code) {
  return sendEmail({
    to,
    subject: "HealthTrack — Confirm Email Change",
    template: {
      type: "otp",
      data: {
        code,
        title:    "Confirm Your New Email",
        subtitle: "Enter this code in HealthTrack to confirm your new email address.",
...
export function sendVerificationEmail(to, code) {
  return sendEmail({
    to,
    subject: "HealthTrack — Verify Your Email",
    template: {
      type: "otp",
      data: {
        code,
        title:    "Verify Your Email",
        subtitle: "Enter this code in HealthTrack to verify your email address.",
        note:     "This code expires in 10 minutes.",
      },
    },
  })
